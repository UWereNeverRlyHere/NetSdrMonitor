...
{
   /// <summary>
   /// Аналізує вхідний буфер і повертає контекст аналізу, що містить хедер та статус:
   /// Ready (зібралося ціле повідомлення),
   /// Incomplete (бракує байтів)
   /// або Corrupt (структурно зіпсовано - потрібен ресинк).
   /// </summary>
