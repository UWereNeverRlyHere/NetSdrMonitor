...
>
> ![Консоль монітора](docs/images/console.png)
...
- **Сховище** записів: летке в пам'яті або файлове **SQLite** (перемикається галочкою).
...
а *всередині* шарів Core і Presentation — організація **за фічами** (feature folders), що дає когезію
в дусі VSA без церемоній MediatR.
