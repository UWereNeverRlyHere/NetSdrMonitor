...
public sealed class MockSignalServer : ISignalServer
{
    ...
    private async Task ReceiveCommandsAsync(
        PipeReader reader, NetworkStream stream, SemaphoreSlim sendGate, RunFlag run, CancellationToken ct)
    {
    ...
    private async Task HandleCommandAsync(
        NetworkStream stream, SemaphoreSlim sendGate, SdrMessage message, RunFlag run, CancellationToken ct)
    {
    ...
    private static async Task SendAsync(
        NetworkStream stream, SemaphoreSlim sendGate, ReadOnlyMemory<byte> bytes, CancellationToken ct)
    {
